...
% Matthew's recorded lecture for this day. The video is scheduled and not yet
% public, so the title lookup 403s until it premieres — the page shows the
% "title unavailable" fallback, and the player unlocks by itself when it goes
% live. The real title arrives on the first rebuild after the premiere.
\youtube{SzVmiN8BvCc}
