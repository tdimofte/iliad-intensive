...
\begin{center}
\includegraphics[width=0.9\textwidth,height=0.75\textheight,keepaspectratio]{figures/cnn_diagram.png}
\end{center}
...
\begin{frame}{Argument 1: Feature Visualization}
\begin{columns}[c]
...
\begin{frame}{Argument 2: Dataset Examples}
\begin{columns}[c]
...
\begin{frame}{Argument 3: Synthetic Examples}
\begin{columns}[c]
\begin{column}{0.4\textwidth}
...
\begin{frame}{Argument 4: Joint Tuning}
\begin{columns}[c]
\begin{column}{0.35\textwidth}
...
\begin{frame}{Argument 5: Feature Implementation}
\begin{columns}[c]
\begin{column}{0.4\textwidth}
...
\begin{frame}{Argument 6: Feature Use}
\begin{columns}[c]
\begin{column}{0.35\textwidth}
...
\begin{frame}{Argument 7: Handwritten Circuits}
\begin{columns}[c]
\begin{column}{0.35\textwidth}
...
\begin{frame}{A Complex Feature: Cars in Superposition}
\begin{center}
...
\begin{frame}{Feature Visualization Exercise}
\begin{center}
\vfill
\href{https://colab.research.google.com/github/iliad-team/iliad-intensive-C.2/blob/main/exercises/03_feature_viz/notebook.ipynb}{%
\colorbox{structure.fg}{\color{white}\LARGE\bfseries\strut\quad Feature Visualization Exercise\quad}}
\vfill
\end{center}
\end{frame}
