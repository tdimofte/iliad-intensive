...
**Fact 7.5 (Blackwell–Dubins merging of opinions ([Blackwell & Dubins 1962](#bib-blackwell-62))).** If $Q$ covers $P$, then $\sup_{S} |P(S \mid \aes_{<t}) - Q(S \mid \aes_{<t})| \to 0$ $P$-almost surely, where the supremum ranges over all measurable events $S$ (including events on infinite histories).
